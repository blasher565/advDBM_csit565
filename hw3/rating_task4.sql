...
Homework 3 - Part 1, Tasks 4
*/

/* Delete the tables if they already exist */
/* Moved Rating to top due to FK */
...
create table Rating(rID int,
                    ...
                    CONSTRAINT rat_fk_0 FOREIGN KEY( rID ) REFERENCES Reviewer(rID)
                    ON UPDATE CASCADE 
                    ON DELETE SET NULL,
                    CONSTRAINT rat_fk_1 FOREIGN KEY( mID ) REFERENCES Movie(mID)
                    ON DELETE CASCADE
                    );
